...
(function() {
  ...
  const translations = {
    en: {
      ...
      'achievement-ztgk-text': 'I placed top 3 with my team in the ZTGK competition in Łódź',
      ...
      'achievement-elympics-text': 'In the Elympics GameCamp Arena 2024 competition, where the task was to create a mobile game using their API, my team won 1st place in the Community Vote category',
      ...
      'achievement-geek-text': 'In the GEEK competition organized by PTI in the game implementation category, my team won 1st place',
    ...
    pl: {
      ...
      'achievement-ztgk-date': '06.2025',
      'achievement-ztgk-text': 'Zająłem z zespołem 3. miejsce w konkursie ZTGK w Łodzi',
      'achievement-ztgk-game': 'Gra:',
      'achievement-ztgk-comp': 'Konkurs:',
      'achievement-elympics-title': '1. miejsce w kategorii Community Vote',
      'achievement-elympics-date': '09.2024',
      'achievement-elympics-text': 'W konkursie Elympics GameCamp Arena 2024, w którym zadaniem było stworzenie gry mobilnej z użyciem ich API, mój zespół zdobył 1. miejsce w kategorii Community Vote',
      'achievement-elympics-game': 'Gra:',
      'achievement-elympics-comp': 'Konkurs:',
      'achievement-geek-title': '1. miejsce na etapie wojewódzkim',
      'achievement-geek-date': '05.2023',
      'achievement-geek-text': 'W konkursie GEEK organizowanym przez PTI w kategorii implementacji gry mój zespół zdobył 1. miejsce',
